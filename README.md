Hey👋👋!!This is a weather app built using HTML,CSS & Javascript💻.This weather app fetches some random images and sets it to enhance the UI everytime search button is clicked.
